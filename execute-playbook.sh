...
ansible-playbook -i $host $playbook --extra-vars "storageaccountname=$storageaccountname filesharename=$filesharename storageaccountkeys=$storageaccountkeys" -vvvv
